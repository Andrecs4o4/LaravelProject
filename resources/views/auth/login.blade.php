...
<head>
    ...
    <title>Login &mdash; Upn Veteran Yogyakarta</title>
            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <form action="{{ route('register') }}" class="needs-validation" novalidate="">
                        <div class="form-group text-right">
                                <button href="{{ route('register') }}" class="btn btn-success btn-lg btn-icon icon-right" tabindex="4">
                                    Register
                                </button>
                            </div>
                            </form>
                        <div class="text-center mt-5 text-small">
                            Copyright 2021 &copy; . Made with 💙 by Andre Christian Surbakti
                        </div>
                    </div>
                </div>
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="../assets/img/unsplash/login.jpg">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            ...
                            Photo by <a class="text-light bb" target="_blank" href="https://www.instagram.com/upnvy/?hl=id">UPN </a>
                        </div>
                    </div>
                </div>
            </div>
